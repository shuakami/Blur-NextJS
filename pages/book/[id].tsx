    ...
    <div className="min-h-screen bg-white text-sm">
      ...
      <div className="mx-auto pt-20 max-w-[min(1000px,90vw)] min-w-[min(100%,320px)] px-[clamp(20px,5vw,80px)]">
        ...
        <div className="group">
          {/* 顶部按钮组 */}
            <div
                className="flex gap-[clamp(4px,0.5vw,6px)] mb-3 -ml-2 opacity-0 group-hover:opacity-100 transition-opacity">
                <button
                    className="flex items-center h-[clamp(22px,2.4vw,28px)] px-[clamp(3px,0.4vw,5px)] rounded-sm hover:bg-gray-100 text-gray-400">
