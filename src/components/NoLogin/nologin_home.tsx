    ...
    return (
        <div className="w-full h-screen flex overflow-hidden">
            ...
            >
                ...
                <div
                    className="w-full h-screen flex items-center justify-center text-foreground">
                    <div className="max-w-4xl mx-auto px-4 py-8 flex flex-col items-center justify-center h-full">
                        ...
                        <h2 className="text-2xl font-bold mb-2">我们找不到对话历史</h2>
                        <p className="text-muted-foreground text-sm-md mb-6">
                            请先尝试登录。无论是聊天还是创作，Blur都能手到擒来。
                        </p>
                        <div className="space-x-4">
                            <Button variant="default">
                                <LogIn className="mr-2 h-4 w-4" onClick={() => router.push('/login')}/> 登录
                            </Button>
                            <Button variant="outline">
                                <UserPlus className="mr-2 h-4 w-4" onClick={() => router.push('/signup')}/> 注册
                            </Button>
                        </div>
                    </div>
                </div>
